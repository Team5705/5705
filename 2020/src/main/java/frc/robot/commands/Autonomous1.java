...
public static final int timeDelay = 1; //Tiempo de espera en segundos
  ...
  public Autonomous1(Powertrain powertrain) {
    ...
    super(new Distance(powertrain, 3,0,0,0), new WaitCommand(timeDelay), 
          new TurnPID(powertrain, 180,0,0,0),  new WaitCommand(timeDelay),
          new Distance(powertrain, 3,0,0,0), new WaitCommand(timeDelay), 
