...
public class XboxControllerMap extends Joystick {
	 ...
	 * Set deadband
	 * 
	 * @param deadband If the magnitude of the axis is less than this value, it will
	 *                 be considered a 0.
	 */
	 ...
	 * Get deadband
	 * 
	 * @return deadband If the magnitude of the axis is less than this value, it
	 *         will be considered a 0.
	 */
	 ...
	 * 
	 * @return the angle of the DPad in degrees, or -1 if the DPad is not pressed.
	 */
	public int getDPad() {
		return getPOV();
	}
